...
constructor(@ApplicationContext private val context: Context) {
  private val dataStore: androidx.datastore.core.DataStore<ScheduledNotifications> =
    ...
    val calendar =
      java.util.Calendar.getInstance().apply {
        ...
        if (notification.hasYear() && notification.hasMonth() && notification.hasDay()) {
          set(java.util.Calendar.YEAR, notification.year)
          set(java.util.Calendar.MONTH, notification.month - 1)
          set(java.util.Calendar.DAY_OF_MONTH, notification.day)
        }
        set(java.util.Calendar.HOUR_OF_DAY, notification.hour)
        set(java.util.Calendar.MINUTE, notification.minute)
